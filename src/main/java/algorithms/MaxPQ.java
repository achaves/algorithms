...
public class MaxPQ<Key> implements Iterable<Key> {
    ...
    /**
     * Unit tests the <tt>algorithms.MaxPQ</tt> data type.
     */
    public static void main(String[] args) {
        //algorithms.MaxPQ<Integer> pq = new algorithms.MaxPQ<Integer>(new Integer[] {98, 89, 87, 77, 64, 31, 51, 13, 20, 16}); //{92, 83, 74, 77, 44, 36, 23, 22, 64, 20});
        MaxPQ<Integer> pq = new MaxPQ<Integer>(new Integer[] {23, 45, 48, 26, 31, 13, 22, 17, 15, 29});
